...
type createStory struct {
	...
	Body struct {
		...
		Points string `json:"points" enums:"none,one,two,three,five,eight,thirteen" example:"three"`
...
type updateStory struct {
	...
	Body struct {
		...
		// The number of points associated with the story.
		Points *string `json:"points,omitempty" enums:"none,one,two,three,five,eight,thirteen" example:"three"`
		// The description of the story.
