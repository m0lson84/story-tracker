// Package stories provides HTTP handlers and data transfer objects for story management operations.
package stories
...
// ListResponse represents the response for a list of stories.
