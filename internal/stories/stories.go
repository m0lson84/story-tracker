// Package stories provides business logic for story management operations.
package stories
...
// DeleteStory deletes a story record by ID.
...
// GetStory retrieves a story record by ID.
...
// UpdateStory updates an existing story record.
